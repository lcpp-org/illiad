"""Shared geometry and attenuation helpers for SOL profile stitching."""
...
__all__ = [
    ...
    "RHO_FILENAME",
    "THETA_FILENAME",
    "bridge_connection_length_paths",
    "construct_path_attenuation",
    "evaluate_exterior_profile",
    "load_inputs",
    "make_grid",
...
def load_inputs(data_dir, sol_subdir, core_field_subdir, core_field_filename, *,
