"""Output-directory, data, plot, and logging support."""
...
class IOHandler:
    ...
    def borisBoilerplate(self, param_dict):
        """Log the merged Boris configuration and its derived values."""
        ...
        self.log.info('\n|=======================================================================================|'
                      ...
                      +'\n| TRACE OUTPUT STRIDE: {}'.format(param_values["STRIDE"])
