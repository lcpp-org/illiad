...
#
#
#            #self.log.info('Cartesian Vector field loaded from file {}:\n'.format(name)
#            #               +'# --------- FIELD MESH DATA --------- #\n'
#            #              +'# Size: {}\n'.format(self.Bx.shape)
#            #              +'# Periodicity: {}\n'.format(self.periodicity)
#            #              +'# r min/max [meters]= {}/{}\n'.format(self.r_min, self.r_max)
#            #              +'# theta min/max [deg.]= {}/{}\n'.format(degrees(self.theta_min), degrees(self.theta_max))
#            #              +'# phi min/max [deg.]= {}/{}\n'.format(degrees(self.phi_min), degrees(self.phi_max))
#            #              +'# dr = {} m.\n'.format(self.dr)
#            #              +'# dtheta = {} deg.\n'.format(degrees(self.dtheta))
#            #              +'# dphi = {} deg.\n'.format(degrees(self.dphi))
#            #               +'# ------------------------------------ #\n')
...
class CartesianField(Mesh):
    ...
    __init__Mesh = Mesh.__init__
    def __init__(self, mesh):
        self.__init__Mesh(mesh)
